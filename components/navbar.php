...
<script src="/utils/easter-eggs.js" defer></script>
    ...
    <ul class="monster-links me-auto">
      ...
      <li>
        <a href="/roulette">
          <span>Roulette</span>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" d="M12 3v3m0 12v3m9-9h-3M6 12H3m15.364-6.364-2.121 2.121M7.757 16.243l-2.121 2.121m12.728 0-2.121-2.121M7.757 7.757 5.636 5.636" />
          </svg>
        </a>
      </li>
      <?php } ?>
